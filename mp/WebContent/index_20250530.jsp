...
<!-- in-page styles -->
<style>
header {z-index:4;position:fixed;top:0;width:100%;background-color:rgba(255, 255, 255, 0.5);border-bottom:0;}
header:hover {background-color:white;}
#navigation-items-block {position:fixed;margin-top:57px !important;background-color:rgba(255, 255, 255, 1);}
main {clear:both;min-height:0;}

div.banner {
  position:absolute;top:0;height:560px;left:-10px;width:calc(100% - 20px);padding:20px;padding-top:80px;
  color:#000;line-height:1.4em;font-size:1.2em;border:0;border-bottom:1px solid #ddd;
...
div.banner>div.wrapper>p>strong {border-bottom:1px solid #fff;}
div.banner span.member-cnt {font-size:3.3em;vertical-align:top;}

div.banner-btns {z-index:3;position:absolute;font-size:30px;top:580px;color:#aaa;display:flex;flex-flow:row wrap;justify-content:center;width:100%;}
...
ul.direct-links>li {position:relative;width:96px;margin:10px 0px 30px 0px;text-align:center;transition:color .2s ease-in-out;}
ul.direct-links>li>a {color:#07a9fa;transition:color .2s ease-in-out;} /*#07a9fa;*/
ul.direct-links>li>a:hover {color:#246ceb;cursor:pointer;} /*#246CEB*/
ul.direct-links>li i {font-size:4em;margin-top:21px;line-height:1.6em;transition:font-size .3s, margin-top .3s;}
ul.direct-links>li i:hover {font-size:5em;margin-top:0;}
/* ul.direct-links>li i:hover {text-shadow: 0px 0px 15px #000;} */
...
span.due-date {background-color:#FF5733;color:white;padding:3px 5px;border-radius:3px;}

ul.customer-service-block {clear:both;position:relative;display:flex;flex-flow:row wrap;}
...
ul.customer-service-block>li:first-child {padding-left:0;}
ul.customer-service-block>li:last-child {flex-grow: 1;padding-right:0;}
ul.customer-service-block div.title {width:100%;font-size:1.6em;font-weight:bold;vertical-align:top;border-bottom:1px solid #fafafa;height: 40px;}
...
li.customer-service-block-li-separator {border-right:1px solid #ddd;max-width:300px;}
.notice-list {max-width:450px;}

ul.bank-list {display:flex;flex-flow:row wrap;}
ul.bank-list li {width:100px;}
...
$(document).ready(function() {
  $("ul.bank-list").load("<%=request.getContextPath()%>/static/BankUrl.htm?2025");
  showBannerButton();
  ...
  /*
  $(".direct-links li").each(function(idx,item){
    var abs = Math.abs(idx - ($(".direct-links li").length/2));
	$(item).delay(1000).slideDown(300*abs);   
  });
  */
...
<%@ include file="./web/includes/Navigation.jsp" %>
  ...
  <div class='banner' style='background-image:url("//image.mp1.co.kr/images/banner/amain.jpg");background-position:center;color:#555;'>
    <div class='wrapper'>
  ...
  <div class='banner' style='display:none;background-image:url("//image.mp1.co.kr/images/banner/billtax.jpg");color:#555;'>
    <div class='wrapper'>
  ...
  <div class='banner' style='display:none;background-image:url("//image.mp1.co.kr/images/banner/c.jpg");'>
    <div class='wrapper' style='opacity:0.6;'>
  ...
  <main style='clear:both;margin-top:650px;'>
    <div class='wrapper'>
      ...
      <ul class='direct-links'>
        ...
        <li class='mobile_hide'><a href='/mp/web/customer/guide/BankWorkTime.jsp'><i class="fa-solid fa-clock"></i><br/>인터넷 뱅킹<br/>시간 확인</a></li>
        <li><a href='<%=request.getContextPath()%>/web/customer/'><i class="fa-solid fa-person-circle-question"></i><br/>도움이 필요<br/>하세요?</a></li>
        <!-- li class='mobile_hide'><a href='/mp/web/customer/download/Downloads.jsp'><i class="fa-solid fa-cloud-arrow-down"></i><br/>필수프로그램<br/>다운로드</a></li -->
      ...
      <ul class='customer-service-block'>
        ...
        <li class='customer-service-block-li-separator tablet-hide'>
          <div class='title'>인터넷뱅킹 바로가기</div>
          <ul class='bank-list'></ul>
        </li>
        <li>
          <div class='title' style='width:100%;'>공지사항
            <span class='more' style='font-size:0.6em;'><a href='<%=request.getContextPath()%>/web/customer/notice/Notices.jsp' class='btn white add-more'><i class="fa-solid fa-plus"></i></a></span>
          </div>

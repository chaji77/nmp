...
String PIMS_UPLOAD_DEFAULT_PATH = ConfigurationMgr.getInstance().getString("UPLOAD_FILE_PATH") + "customer/";
String PIMS_DOWNLOAD_URL        = ConfigurationMgr.getInstance().getString("UPLOAD_FILE_URL") + "customer/";
...
try {
  ...
  logger.error("공지사항관리에서 파일업로드에 실패하였습니다. @see /c/notice/UploadFileProc.jsp");
  logger.error(e.toString());
}

out.println("<script>parent.callbackAddedFile('" + PIMS_DOWNLOAD_URL + strFilePath + "', '" + strFileSize + "');</script>");
%>

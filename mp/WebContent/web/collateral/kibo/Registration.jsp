...
<style>
input[type='text'], input[type='date'] {width:30%;margin-right:10px;}
...
function goSubmit() {
  ...
  showCustomConfirm(msg, function() {
    $.post("https://w4.mp1.co.kr/guarantee_sys/yesb2b/secu_grt/kibo/grt_req_write_act_cross.jsp", $("form[name='frmEnt']").serialize(), function(data) {
...
<input type="hidden" id="adr_desc1" name="adr_desc1" value="">
<input type="hidden" id="adr_zipcode" name="adr_zipcode" value="">
<input type="hidden" id="cpy_tel" name="cpy_tel" value="">
<input type="hidden" id="cudType" name="cudType" value="C">
...
<ul class='detail'>
  ...
  <li class='th'>본사연락처</li>
  <li class='td'><input type='text' name='cpy_tel'></li>
  <li class='th'>담당자명</li>
  <li class='td'><input type="text" id="txt_sellerManagetName" name="txt_sellerManagetName" class="form-control form-control-sm d-inline w-auto" size="20" maxlength="40" value=""></li>
  <li class='th'>담당자연락처</li>
  <li class='td'><input type="text" id="txt_sellerManagetTelno" name="txt_sellerManagetTelno" class="form-control form-control-sm d-inline w-auto" size="25" maxlength="13" value=""></li>
  <li class='th'>담당자이메일</li>
  <li class='td'><input type="text" id="txt_sellerManagetEmail" name="txt_sellerManagetEmail" class="form-control form-control-sm d-inline w-auto" size="25" maxlength="40" value=""></li>
</ul>
...
<ul class='form'>
  ...
  <li>
    <label>발급희망일</label>
    <input type="date" id="txt_favoritedate" name="txt_favoritedate">
  </li>
  <li>
    <label>신청자명</label>
    <input type="text" id="txt_applicantName" name="txt_applicantName" class="form-control form-control-sm d-inline w-auto" size="20" maxlength="40" value="">
  </li>
  <li>
    <label>신청자연락처</label>
    <input type="text" id="txt_applicantTelno" name="txt_applicantTelno" class="form-control form-control-sm d-inline w-auto" size="25" maxlength="13" value="">
  </li>
  <li>
    <label>신청자 이메일</label>
    <input type="text" id="txt_applicantEmail" name="txt_applicantEmail" class="form-control form-control-sm d-inline w-auto" size="25" maxlength="40" value="">
  </li>
  <li>
    <label>비고</label>

...
div.footer-nav, div.footer-nav a {color:#78B3EA;}
...
<!--   <video id="video" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
  ...
  <div class='banner' style="background-image:url('<%=request.getContextPath()%>/static/images/banner/amain.jpg');background-size:cover; background-position:center; background-repeat:no-repeat; color:#555;">
    <div class='wrapper'>
  ...
  <div class='banner' style="display:none; background-image:url('<%=request.getContextPath()%>/static/images/banner/billtax.jpg'); background-size:cover; background-position:center; background-repeat:no-repeat; color:#555;">
    <div class='wrapper'>
  ...
  <div class='banner' style="display:none; background-image:url('<%=request.getContextPath()%>/static/images/banner/c.jpg'); background-size:cover; background-position:center; background-repeat:no-repeat; color:#555;">
    <div class='wrapper'>

...
import kr.co.soap.kodit.loan.Kodit_B315;

public class EmtNetB315 extends Kodit_B315 {
	...
	protected void makeB31X(int intCtId, String p_user) throws Exception {
		...
		this.xml_b311.setFund("KODIT"); // 신보
	...
	protected void updateDBWithResponse(CommonElement p_commonElement) throws Exception {
	    ...
	    {
	    	TalkCtrl.sendBySystem("M007", 0, sendXmlB311VO.CTID, 0);	// SEND MESSAGE VIA KAKAOTALK for CONTRACT CANCEL
	    }
	}

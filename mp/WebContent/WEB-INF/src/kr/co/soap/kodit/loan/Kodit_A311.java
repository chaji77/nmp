...
public abstract class Kodit_A311
{
    ...
    protected Kodit_A311() { }

    protected Kodit_A311(String p_MPCode)
    {
    ...
    public A312VO executeA311()
    {
        ...
        try
        {
            ...
            {
                this.kodit_A312VO.getCommonElement().setResponseCode(commonElement.getResponseCode());
                this.kodit_A312VO.getCommonElement().setResponseMessage(commonElement.getResponseMessage());
            }
            else
            {
                this.makeA311XML();
                this.kodit_A312VO = this.sendA311();
            }
        }
        catch (Exception ex)
        {
    ...
    private void executeException(Exception ex) {
        ...
        kodit_A312VO.getCommonElement().setResponseMessage((exMsg == null || exMsg.length() < 50) ? exMsg : exMsg.substring(0, 50));
    }
    ...
    {
        String file_name = "";
        file_name = XmlEnum.getTemplatePath("A311.xml");
    ...
    private void setResponseDetails(A312VO kodit_A312) {
        ...
        //kodit_A312.setBankLimitSpare("Y".equals(XMLUtil.getNodeValueOption(resDoc, "sb:BankLimitSpareYN", 0))
        //    ? XMLUtil.getNodeValue(resDoc, "sb:BankLimitSpare") : "0");
    }
}

...
public class EmtNetB311 extends Kodit_B311 {
    ...
    protected void makeB31X(int intCtId, String p_user) throws Exception {
        ...
        String sub_item = substringByByte(main_item, 30);
        
        // 30바이트 기준으로 자르기
		/*
		 * if (strByte.length <= 30) { sub_item = main_item; // 길이가 30바이트 이하이면 그대로 사용 }
		 * else { // 30바이트를 기준으로 잘라서 사용 sub_item = new String(strByte, 0, 30); }
		 */
    ...
    private String substringByByte(String str, int maxBytes) throws Exception {

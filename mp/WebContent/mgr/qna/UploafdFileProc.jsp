...
String PIMS_UPLOAD_DEFAULT_PATH = ConfigurationMgr.getInstance().getString("UPLOAD_FILE_PATH") + "qna/";
String PIMS_DOWNLOAD_URL        = ConfigurationMgr.getInstance().getString("UPLOAD_FILE_URL") + "qna/";
...
try {
  ...
  logger.error("1대1문의에서 파일업로드에 실패하였습니다. @see /c/qna/UploadFileProc.jsp");

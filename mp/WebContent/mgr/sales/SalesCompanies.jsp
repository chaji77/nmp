    ...
    <td>
     <ul>
        ...
        <li>
          ...
          <option value='3'<%=(pvo.CPY_GUBUN.equals("3"))?" selected":"" %>>구&판매사</option>
          </select>
        </li>
      </ul>
    </td>
...
<table id='target-list' class='list detail clickable-tr' style='font-size:15px;'>
  <thead>
   <tr class='mobile_hide'>
     <th class='left' style='width:5%;'>구분</th>
     <th class='left' style='width:11%;'>회사명</th>
     ...
     <th class='left' style='width:6%;'>매출액 (백만원)</th>
     <th class='left' style='width:4%;'>종업원수</th>
     <th class='left' style='width:5%;'>설립일</th>
     <th class='left' style='width:20%;'>소재지</th>
     <th class='left' style='width:13%;white-space:nowrap;'>비고</th>
   </tr>
  </thead>
  <tbody>
<%
...
%>
   <tr onclick='goDetail("<%=strId %>");'>
     <td class='mobile_hide'><%=(v.CPY_GUBUN.equals("1"))?"구매사":v.CPY_GUBUN.equals("2")?"판매사":"구&판매" %></td>
     ...
     <td class='mobile_hide'><%=FormatUtil.addSeparatorDate(v.CPY_FOUNDYEAR, ".") %></td>

...
for (int i=0; i<arrItemMonth.length; i++) {
  ...
  arrTradeItem.add(t);
  /* */
  System.out.println(arrItemMonth[i]);
  System.out.println(arrItemDate[i]);
  System.out.println(arrItemName[i]);
  System.out.println(arrItemSpec[i]);
  System.out.println(arrItemCnt[i]);
  System.out.println(arrItemUnit[i]);
  System.out.println(arrItemPrice[i]);
  System.out.println(arrItemTax[i]);
  /* */
  System.out.println("----------------------");
  System.out.println(t.strPurchaseExpiry);
  System.out.println(t.strName);
  System.out.println(t.strInformation);
  System.out.println(t.strChargeableUnit);
  System.out.println(t.strUnitPrice);
  System.out.println(t.strAmount);
  System.out.println(t.strTax);
  System.out.println(t.strDescription);
...
try {
  ...
  if (intBillSeq>0) {
    ...
    out.println("<script>location.href='TaxRequestList.jsp';</script>");
/*
    Tax tax = new Tax();
    int intResult = tax.RegistAndIssueTaxInvoice(vo);

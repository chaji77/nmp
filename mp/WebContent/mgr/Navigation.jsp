...
<body>
  <header>
    ...
    <ul id='navigation'>
      <li class='navigation-li-col nav-001'><a href='<%=request.getContextPath()%>/mgr/customer/Companies.jsp'>회원관리</a></li>
      ...
      <li class='navigation-li-col nav-004'><a href='<%=request.getContextPath()%>/mgr/notice/Notices.jsp'>사이트관리</a></li>
    </ul>
    <aside>
    ...
    <ul id='navigation-items'>
      ...
      <li class='navigation-li-col'>
        <ul class='nav-004'><!-- 사이트관리 -->
          ...
          <li><a href='<%=request.getContextPath()%>/mgr/qna/Qnas.jsp'>1:1문의</a></li>

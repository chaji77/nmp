package kr.co.funology.maven.fw;
...
public class GlobalEnv {
    ...
    public  static String GLOBAL_CONNECTION_NAME = "/jdbc/rcftp";
    ...
    public static String getWebRootDir() {
        if (GLOBAL_WEBROOT_DIR == null) {
            try {
                GLOBAL_WEBROOT_DIR = new File(System.getProperty("catalina.base"), "webapps").getAbsolutePath();
                System.out.println("WebContent Root Directory : " + GLOBAL_WEBROOT_DIR);
            } catch (Exception e) {
                System.out.println("getWebRootDir_Error::::::::::::::::"+e.toString());
                GLOBAL_WEBROOT_DIR = "D:/WorkSpace/mp/WebContent/";
            }
        }

...
function goPage(p) {
  ...
  document.frmSearch.action = "Contracts.jsp";
  document.frmSearch.submit();
}
function calc(ctid) {
...
<tbody>
  <tr>
      ...
      <ul>
        ...
        <li class='search-option-status'>
          ...
          <select name='sbdate' onChange="goPage(1);">
            ...
            <option value="F" <%=(pvo.SBDATE.equals("F"))?"selected":""%>>결제완료일</option>
    ...
    <td class='btn' style='text-align:right;'>
      ...
      <a href='Contracts.jsp'><i class="fa-solid fa-rotate-right" style='font-size:1.7em;margin-right:10px;'></i></a>
    </td>
  </tr>
</tbody>
</table>
...
%>
    <tr>
      ...
      <td class='left'><%=FormatUtil.addSeparatorDate(vo.SETTLEDUEDATE)%>
        ...
        if ((vo.STATUS.equals("040") || vo.STATUS.equals("050")) && vo.SETTLEDUEDATE.equals(today)) { %>
      ...
      <td class='left'>
        <% if (vo.STATUS.equals("030") || vo.STATUS.equals("040") || vo.STATUS.equals("050") || vo.STATUS.equals("060") || vo.STATUS.equals("070") || vo.STATUS.equals("080") || vo.STATUS.equals("090") || vo.STATUS.equals("707")) { %>
      ...
      <td class='left commands'>
         <% if (!"060,070,080".contains(vo.STATUS)) { %>
...
<form name='frmToExcel' method='post' action='ContractsForExcel.jsp' target='FrameForExcel'>
  <input type='hidden' name="cpy_id" value="<%=intCpyId %>" />
  <input type='hidden' name="cpy_nm" value="<%=strCpyNm %>" />
  <input type='hidden' name="page" value="1" />
  <input type='hidden' name="status" value="<%=pvo.STATUS %>" />
  <input type='hidden' name="ctno" value="<%=pvo.CTNO %>" />
  <input type='hidden' name="sbdate" value="<%=pvo.SBDATE %>" />

...
function getToSend(sent) {
  $('#contract_list').find('input[name="seq"][value="'+sent+'"]').closest('tr').remove();
...
function goLoopSubmit(sent) {
  var toSend = getToSend(sent);
  console.log(toSend);
  if (toSend>0) {
    $.ajax({

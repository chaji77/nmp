...
function movePage(p) {
  ...
  $("#ResultSet").html("");
  $.post("https://w4.mp1.co.kr/guarantee_sys/yesb2b/secu_grt/kibo/grt_limit_buy_issue_view_cross.jsp", $("form[name='frmSearch']").serialize(), function(data) {
    $("#ResultSet").html(data);
    hideSpinner();
  });
}
...
<div class='page-title-block'>
  <span class='title'>보증서 발급내용</span>
  <span class='more'>
...
<%
System.out.println(StrUtil.nvl(request.getParameter("applNO")));
%>
<div id='ResultSet'>

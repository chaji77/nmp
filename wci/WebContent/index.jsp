...
body {
  ...
  #background-image:url(//image.mp1.co.kr/wci/banner/dinosaur.webp);
  background-position: right top;
  #background-size: 40%;
  background-image:url(//image.mp1.co.kr/wci/banner/plane.png);
  background-size: 60%;
...
div.banner {
  position:absolute;top:0;left:-10px;width:calc(100% - 20px);padding:20px;padding-top:50px;
...
div.banner>div.wrapper>h1 {font-size:1.8em;line-height:1.3em;letter-spacing:-1px;margin-top:140px;margin-bottom:50px;}
div.banner>div.wrapper>h2 {font-size:1.3em;margin:30px 0 0 0;line-height:2em;}
div.banner>div.wrapper>p {text-align:justify;}
...
ul.direct-links {clear:both;display:flex;flex-flow:row wrap;justify-content:center;min-height:185px;}
...
ul.direct-links>li:hover {margin-top:0px;}
ul.direct-links>li>a {color:#555;}
ul.direct-links>li>a:hover {cursor:pointer;color:#000;}
ul.direct-links>li i {font-size:4em;margin-top:0px;line-height:1.6em;transition:font-size .3s ease-in-out, margin-top .3s ease-in-out;}
ul.direct-links>li i:hover {font-size:5.3em;margin-bottom:-10px;}
...
span.due-date {color:#FF5733;font-size:1.2em;font-weight:bold;}

ul.customer-service-block {clear:both;position:relative;display:flex;flex-flow:row wrap;color:#000;}
ul.customer-service-block>li {min-width:300px;min-height:250px;padding-left:20px;padding-right:20px;padding-top:40px;border-top:1px solid #ddd;}
ul.customer-service-block>li:first-child {max-width: 300px;padding-left:0;border-right:1px solid #ddd;}
ul.customer-service-block>li:nth-child(even) {flex-grow: 1;border-right:1px solid #ddd;}
ul.customer-service-block>li:last-child {padding-right:0;}
...
#main2 {clear:both;margin-top:530px;}
...
@media only screen and (max-width:767px) {
  ...
  ul.customer-service-block>li {width:100%;padding:0;padding-top:40px;border-right:0 !important;}
  ul.customer-service-block>li:first-child {max-width:100%;}
  ...
  #main2 {background-color:#fff;padding-top: 20px;}
}
</style>
<script>
var timer_banner;
...
$(document).ready(function() {
  $("ul.bank-list").load("<%=request.getContextPath()%>/static/BankUrl.htm?202506");
  showBannerButton();
...
<%@ include file="./web/includes/Navigation.jsp" %>
  ...
  <video id="video" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
	  <source src="//image.mp1.co.kr<%=request.getContextPath()%>/banner/cover.mp4">
  </video>
  -->
  ...
  <div class='banner-btns' style='display:none;'></div>

...
ul.form-box a.btn {padding:10px 15px;}
  ...
  if (check()) {
    $.post("BizNoCheck.jsp", $("form[name='frmEnt']").serialize(), function(data){
      ...
      if (cno!="Y") {
        ...
        document.frmEnt.action = "Registration.jsp";
...
<ul class='step'>
  ...
  <li><strong>STEP 2</strong><br/>회원정보 입력</li><li class='after'></li>

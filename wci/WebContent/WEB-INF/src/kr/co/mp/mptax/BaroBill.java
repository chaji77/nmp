...
public class BaroBill {
  ...
  public BaroBill() {
    try {
      this.cnm          = StrUtil.nvl(ConfigurationMgr.getInstance().getString("OWNER_NM"));
      this.ceo          = StrUtil.nvl(ConfigurationMgr.getInstance().getString("OWNER_CEO"));
      this.cn           = StrUtil.nvl(ConfigurationMgr.getInstance().getString("OWNER_BIZ_NO")).replaceAll("-", "");
      this.p_addr1      = StrUtil.nvl(ConfigurationMgr.getInstance().getString("OWNER_ADDR"));
      this.p_addr2      = "";
      ...
      this.cpw          = StrUtil.nvl(ConfigurationMgr.getInstance().getString("ETAX_PASSWD"));
      this.p_bizType    = StrUtil.nvl(ConfigurationMgr.getInstance().getString("BIZ_TYPE"));
      this.p_bizClass   = StrUtil.nvl(ConfigurationMgr.getInstance().getString("BIZ_CLASS"));
      this.p_memberName = StrUtil.nvl(ConfigurationMgr.getInstance().getString("ETAX_MGR_NM"));
      this.p_email      = StrUtil.nvl(ConfigurationMgr.getInstance().getString("ETAX_MGR_EMAIL"));
    } catch (Exception e) {
  ...
  public static void main(String[] args) {
      BaroBill b = new BaroBill();
      try {
        // b.GetCertificateRegistURL();
        b.GetCertificateExpireDate();

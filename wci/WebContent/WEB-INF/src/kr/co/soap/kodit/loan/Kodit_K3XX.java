...
public abstract class Kodit_K3XX {
    ...
    protected Kodit_K3XX() {}

    public Kodit_K3XX(Document inputDoc) {
        this.doc = inputDoc;
        if (this.doc != null) initializeResponseCommonElement();
    }

    private void initializeResponseCommonElement() {
        this.transactionNO = XMLUtil.getNodeValue(this.doc, "sb:TransactionNO");
        this.resCommonElement.setResponseCode("0000");
        this.resCommonElement.setSender(XMLUtil.getNodeValue(this.doc, "sb:Sender"));
        this.resCommonElement.setTransactionSEQNO(XMLUtil.getNodeValue(this.doc, "sb:TransactionSEQNO"));
        this.resCommonElement.setReceiver(XMLUtil.getNodeValue(this.doc, "sb:Receiver"));

        String transactionNO = XMLUtil.getNodeValue(this.doc, "sb:TransactionNO");
        this.resCommonElement.setTransactionNO(
            transactionNO.substring(0, 3) + (Integer.parseInt(transactionNO.substring(3, 4)) + 1)
        );

        this.resCommonElement.setTransactionDate(XMLUtil.getNodeValue(this.doc, "sb:TransactionDate"));
        this.resCommonElement.setTransactionTime(XMLUtil.getNodeValue(this.doc, "sb:TransactionTime"));
        this.resCommonElement.setOrderNO(XMLUtil.getNodeValue(this.doc, "sb:OrderNO"));
        this.resCommonElement.setContractDate(XMLUtil.getNodeValue(this.doc, "sb:ContractDate"));
    }
    ...
    private void getCommonElement() {
        this.xmlK311.setSender(XMLUtil.getNodeValue(this.doc, "sb:Sender"));
        this.xmlK311.setTransactionseqno(XMLUtil.getNodeValue(this.doc, "sb:TransactionSEQNO"));
        this.xmlK311.setReceiver(XMLUtil.getNodeValue(this.doc, "sb:Receiver"));
        this.xmlK311.setTransactionno(XMLUtil.getNodeValue(this.doc, "sb:TransactionNO"));
        this.xmlK311.setTransactiondate(XMLUtil.getNodeValue(this.doc, "sb:TransactionDate"));
        this.xmlK311.setTransactiontime(XMLUtil.getNodeValue(this.doc, "sb:TransactionTime"));
        this.xmlK311.setResponsecode(XMLUtil.getNodeValue(this.doc, "sb:ResponseCode"));
        this.xmlK311.setResponsemessage(XMLUtil.getNodeValue(this.doc, "sb:ResponseMessage"));
        this.xmlK311.setUserfield(XMLUtil.getNodeValue(this.doc, "sb:UserField"));
        
        this.xmlK311.setFund("KODIT");
        
        System.out.println("getCommonElement : " + this.xmlK311.getSender());
        System.out.println("getCommonElement : " + this.xmlK311.getTransactionseqno());
        System.out.println("getCommonElement : " + this.xmlK311.getReceiver());
        System.out.println("getCommonElement : " + this.xmlK311.getResponsecode());
        System.out.println("getCommonElement : " + this.xmlK311.getResponsemessage());
        System.out.println("getCommonElement : " + this.xmlK311.getFund());
        
    }

    private void getCommonTransferElement() throws Exception {
        this.xmlK311.setOrderno(XMLUtil.getNodeValue(this.doc, "sb:OrderNO"));
        
        System.out.println("getCommonTransferElement : " + this.xmlK311.getOrderno());
    ...
    protected K311VO getKoditXmlK311() {
        return this.xmlK311;
    }

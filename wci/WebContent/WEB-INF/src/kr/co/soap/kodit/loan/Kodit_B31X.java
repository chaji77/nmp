...
public class Kodit_B31X {
    ...
    protected Kodit_B31X() { }

    protected Kodit_B31X(String p_MPCode) {
    ...
    protected String getTemplate(B311VO p_xml_b311) {
        return XmlEnum.getTemplatePath("B311.xml");
    }
    ...
    protected CommonElement sendB31X(int intCtId, String p_seqNO) throws Exception {
        ...
        CommonElementResInfo resinfo = HttpClientUtil.getCommonElementResInfo(); // HttpClientUtil에서 받은 CommonElement 변환
    ...
    private CommonElement mapToCommonElement(CommonElementResInfo resinfo) {
    	if (resinfo == null) {

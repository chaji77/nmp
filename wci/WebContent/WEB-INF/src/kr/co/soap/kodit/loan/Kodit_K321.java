...
public class Kodit_K321 extends Kodit_K3XX {

	private static final String RESPONSE_SCHEMA = "ResPaymentTakeOver";
	
	public Kodit_K321(Document p_doc) {
        super(p_doc);
        this.resTemplate = XmlEnum.getTemplatePath("K322.xml");
    }
    ...
    protected void getK3XXBodyElement() {
    	...
    	koditXml.setTradedate(getXmlValue("sb:PaymentDueDate"));
    	koditXml.setTradedate(getXmlValue("sb:PaymentDate"));
    	//koditXml.setTradedate(getXmlValue("sb:TradeDate"));  getNodeValue, getNodeValueOption

...
import kr.co.soap.kibo.loan.Kibo_K321;

public class EmtNetK321 extends Kibo_K321 {
...
private SoapCommonVO.CtHeaderVO ctheaderVO  = null;
	...
	protected String validateByK3XX() throws Exception {
		if (!"060".equals(this.ctheaderVO.STATUS)) {
			...
			super.getResCommonElement().setResponseMessage("인수확인을 할 수 있는 상태가 아닙니다. ORDERNO("+ getKiboXmlK311().getOrderno() + " STATUS(" + this.ctheaderVO.STATUS + ")");
